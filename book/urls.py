...
from .views import exchange, exchange_details, exchange_choose_initiators_book, exchange_cancel, exchange_send_message, \
    exchange_successful, report
...
urlpatterns = [
    ...
    path('report', report, name='book_report')
]